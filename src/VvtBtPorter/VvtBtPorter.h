...
extern "C"
{
	...
	EXPORT_FLAG	void		set_time_range(VvTUInt64 stime, VvTUInt64 etime);
	...
	EXPORT_FLAG	CtxHandler	init_sel_mocker(const char* name, VvTUInt32 date, VvTUInt32 time, const char* period, const char* trdtpl = "CHINA", const char* session = "TRADING", int slippage = 0, bool bRatioSlp = false);
