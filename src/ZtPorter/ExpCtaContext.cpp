...
ExpCtaContext::ExpCtaContext(ZtCtaEngine* env, const char* name, int32_t slippage)
...
void ExpCtaContext::on_tick_updated(const char* stdCode, ZTSTickData* newTick)
{
...
void ExpCtaContext::on_bar_close(const char* stdCode, const char* period, ZTSBarStruct* newBar)
{
	//要向外部回调
