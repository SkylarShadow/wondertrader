...
struct ZTSBarStructOld
{
public:
	ZTSBarStructOld()
	{
		memset(this, 0, sizeof(ZTSBarStructOld));
	}
...
struct ZTSTickStructOld
{
	...
	ZTSTickStructOld()
	{
		memset(this, 0, sizeof(ZTSTickStructOld));
	}
};
...
public:
	ZTSBarStruct()
	{
		memset(this, 0, sizeof(ZTSBarStruct));
	}
	...
	//直接复制老结构体
	ZTSBarStruct& operator = (const ZTSBarStructOld& bar)
	{
		date = bar.date;
		time = bar.time;
...
struct ZTSTickStruct
{
	...
	ZTSTickStruct()
	{
		memset(this, 0, sizeof(ZTSTickStruct));
	}

	ZTSTickStruct& operator = (const ZTSTickStructOld& tick)
	{
...
struct ZTSOrdQueStruct
{
	...
	ZTSOrdQueStruct()
	{
		memset(this, 0, sizeof(ZTSOrdQueStruct));
	}
};
...
struct ZTSOrdDtlStruct
{
	...
	ZTSBSDirectType		side;		//委托方向
	ZTSOrdDetailType	otype;		//委托类型

	ZTSOrdDtlStruct()
	{
		memset(this, 0, sizeof(ZTSOrdDtlStruct));
	}
};
...
struct ZTSTransStruct
{
	...
	ZTSTransType	ttype;			//成交类型: 'C', 0
	ZTSBSDirectType	side;			//BS标志
	...
	ZTSTransStruct()
	{
		memset(this, 0, sizeof(ZTSTransStruct));
	}
};
