...
/*
 *	ZTSVariant是一个通用数据容器,设计目标是Json的Value类
 *	和Json不同的地方在于,ZTSVariant满足WT系统内的派生关系
 *	可以通过引用计数管理数据,从而减少数据复制
 */
class ZTSVariant : public ZTSObject
{
public:
	typedef ZTSArray					ChildrenArray;
	typedef ZTSHashMap<std::string>		ChildrenMap;
...
protected:
	ZTSVariant() :_type(VT_Null){}

private:
	static inline ZTSVariant* create(int32_t i32)
	{
		ZTSVariant* ret = new ZTSVariant();
		ret->_type = VT_Int32;
		char s[32] = { 0 };
		sprintf(s, "%d", i32);
	...
	static inline ZTSVariant* create(uint32_t u32)
	{
		ZTSVariant* ret = new ZTSVariant();
		ret->_type = VT_Uint32;
		char s[32] = { 0 };
	...
	static inline ZTSVariant* create(int64_t i64)
	{
		ZTSVariant* ret = new ZTSVariant();
		ret->_type = VT_Int64;
		char s[32] = { 0 };
	...
	static inline ZTSVariant* create(uint64_t u64)
	{
		ZTSVariant* ret = new ZTSVariant();
		ret->_type = VT_Uint64;
		char s[32] = { 0 };
	...
	static inline ZTSVariant* create(double _real)
	{
		ZTSVariant* ret = new ZTSVariant();
		ret->_type = VT_Real;
		char s[32] = { 0 };
	...
	static inline ZTSVariant* create(const char* _string)
	{
		ZTSVariant* ret = new ZTSVariant();
		ret->_type = VT_String;
	...
	static inline ZTSVariant* create(bool _bool)
	{
		ZTSVariant* ret = new ZTSVariant();
...
public:
	static inline ZTSVariant* createObject()
	{
		ZTSVariant* ret = new ZTSVariant();
		ret->_type = VT_Object;
	...
	static inline ZTSVariant* createArray()
	{
		ZTSVariant* ret = new ZTSVariant();
		ret->_type = VT_Array;
	...
	inline ZTSVariant* get(const char* name) const
	{
		if (_type != VT_Object)
			return NULL;
		...
		ZTSVariant* ret = static_cast<ZTSVariant*>(_value._map->get(name));
		return ret;
	}

	inline ZTSVariant* get(const std::string& name) const
	{
		if (_type != VT_Object)
			return NULL;
	...
	inline ZTSVariant* get(uint32_t idx) const
	{
		if (_type != VT_Array)
			return NULL;
		...
		ZTSVariant* ret = static_cast<ZTSVariant*>(_value._array->at(idx));
		return ret;
	}
	...
	inline bool append(const char* _name, const char* _string)
	{
		...
		ZTSVariant* item = ZTSVariant::create(_string);
	...
	inline bool append(const char* _name, int32_t _i32)
	{
		...
		ZTSVariant* item = ZTSVariant::create(_i32);
		_value._map->add(_name, item, false);
		//item->release();
	...
	inline bool append(const char* _name, uint32_t _u32)
	{
		...
		ZTSVariant* item = ZTSVariant::create(_u32);
		_value._map->add(_name, item, false);
		//item->release();
	...
	inline bool append(const char* _name, int64_t _i64)
	{
		...
		ZTSVariant* item = ZTSVariant::create(_i64);
		_value._map->add(_name, item, false);
		//item->release();
	...
	inline bool append(const char* _name, uint64_t _u64)
	{
		...
		ZTSVariant* item = ZTSVariant::create(_u64);
		_value._map->add(_name, item, false);
		//item->release();
	...
	inline bool append(const char* _name, double _real)
	{
		...
		ZTSVariant* item = ZTSVariant::create(_real);
		_value._map->add(_name, item, false);
		//item->release();
	...
	inline bool append(const char* _name, bool _bool)
	{
		...
		ZTSVariant* item = ZTSVariant::create(_bool);
		_value._map->add(_name, item, false);
		//item->release();
	...
	inline bool append(const char* _name, ZTSVariant *item, bool bAutoRetain = true)
	{
	...
	inline bool append(const char* _str)
	{
		...
		ZTSVariant* item = ZTSVariant::create(_str);
	...
	inline bool append(ZTSVariant *item, bool bAutoRetain = true)
	{
