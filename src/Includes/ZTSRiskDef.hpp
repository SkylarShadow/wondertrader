...
class ZTSTradeStateInfo : public ZTSObject
{
protected:
	ZTSTradeStateInfo(){}

public:
	static ZTSTradeStateInfo* create(const char* code)
	{
		ZTSTradeStateInfo* pRet = new ZTSTradeStateInfo();
...
typedef struct _ZTSFundStruct
{
	...
	_ZTSFundStruct()
	{
		memset(this, 0, sizeof(_ZTSFundStruct));
...
class ZTSPortFundInfo : public ZTSObject
{
protected:
	ZTSPortFundInfo(){}

public:
	static ZTSPortFundInfo* create()
	{
		ZTSPortFundInfo* pRet = new ZTSPortFundInfo();
		return pRet;
	}

	ZTSFundStruct&	fundInfo(){ return _fund_info; }
	const ZTSFundStruct& fundInfo() const{ return _fund_info; }
