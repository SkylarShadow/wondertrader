...
//////////////////////////////////////////////////////////////////////////
//委托数据结构,用户客户端向服务端发起
class ZTSEntrust : public ZTSPoolObject<ZTSEntrust>
{
public:
	ZTSEntrust()
		: m_iPrice(0)
...
public:
	static inline ZTSEntrust* create(const char* code, double vol, double price, const char* exchg = "", ZTSBusinessType bType = BT_CASH) noexcept
	{
		ZTSEntrust* pRet = ZTSEntrust::allocate();
		if(pRet)
		{
...
public:
	...
	inline void setDirection(ZTSDirectionType dType)noexcept {m_direction = dType;}
	inline void setPriceType(ZTSPriceType pType)noexcept {m_priceType = pType;}
	inline void setOrderFlag(ZTSOrderFlag oFlag)noexcept {m_orderFlag = oFlag;}
	inline void setOffsetType(ZTSOffsetType oType)noexcept {m_offsetType = oType;}

	inline ZTSDirectionType	getDirection() const noexcept {return m_direction;}
	inline ZTSPriceType		getPriceType() const noexcept {return m_priceType;}
	inline ZTSOrderFlag		getOrderFlag() const noexcept {return m_orderFlag;}
	inline ZTSOffsetType	getOffsetType() const noexcept {return m_offsetType;}

	inline void setBusinessType(ZTSBusinessType bType) noexcept { m_businessType = bType; }
	inline ZTSBusinessType	getBusinessType() const  noexcept { return m_businessType; }
	...
	inline void setContractInfo(ZTSContractInfo* cInfo) noexcept { m_pContract = cInfo; }
	inline ZTSContractInfo* getContractInfo() const  noexcept { return m_pContract; }
...
protected:
	...
	ZTSDirectionType	m_direction;
	ZTSPriceType		m_priceType;
	ZTSOrderFlag		m_orderFlag;
	ZTSOffsetType		m_offsetType;

	char				m_strEntrustID[64] = { 0 };
	char				m_strUserTag[64] = { 0 };

	ZTSBusinessType		m_businessType;
...
//////////////////////////////////////////////////////////////////////////
//委托操作: 撤单、改单
class ZTSEntrustAction : public ZTSPoolObject<ZTSEntrustAction>
{
public:
	ZTSEntrustAction()
	...
	virtual ~ZTSEntrustAction(){}

public:
	static inline ZTSEntrustAction* create(const char* code, const char* exchg = "", ZTSBusinessType bType = BT_CASH) noexcept
	{
		ZTSEntrustAction* pRet = ZTSEntrustAction::allocate();
		if(pRet)
		{
			vvt_strcpy(pRet->m_strExchg, exchg);
			vvt_strcpy(pRet->m_strCode, code);
	...
	static inline ZTSEntrustAction* createCancelAction(const char* eid, const char* oid) noexcept
	{
		ZTSEntrustAction* pRet = new ZTSEntrustAction;
		if(pRet)
		{
...
public:
	...
	inline void setActionFlag(ZTSActionFlag af) noexcept {m_actionFlag = af;}
	inline ZTSActionFlag getActionFlag() const noexcept {return m_actionFlag;}
...
//////////////////////////////////////////////////////////////////////////
//订单信息,查看订单状态变化等
class ZTSOrderInfo : public ZTSPoolObject<ZTSOrderInfo>
{
public:
	ZTSOrderInfo()
	...
	virtual ~ZTSOrderInfo(){}

public:
	static inline ZTSOrderInfo* create(ZTSEntrust* entrust = NULL) noexcept
	{
		ZTSOrderInfo *pRet = ZTSOrderInfo::allocate();
...
public:
	...
	inline void	setOrderID(const char* oid) noexcept { vvt_strcpy(m_strOrderID, oid); }
	inline void	setOrderState(ZTSOrderState os) noexcept {m_orderState = os;}
	inline void	setOrderType(ZTSOrderType ot) noexcept {m_orderType = ot;}
	...
	inline ZTSOrderState		getOrderState() const  noexcept { return m_orderState; }
	inline ZTSOrderType			getOrderType() const  noexcept { return m_orderType; }
	inline const char*			getOrderID() const  noexcept { return m_strOrderID; }
...
private:
	...
	ZTSOrderState	m_orderState;
	ZTSOrderType	m_orderType;
	char			m_strOrderID[64] = { 0 };
	std::string		m_strStateMsg;
};

//////////////////////////////////////////////////////////////////////////
class ZTSTradeInfo : public ZTSPoolObject<ZTSTradeInfo>
{
public:
	ZTSTradeInfo()
		: m_orderType(WORT_Normal)
		, m_tradeType(ZTT_Common)
		, m_uAmount(0)
		, m_dPrice(0)
		, m_businessType(BT_CASH)
		, m_pContract(NULL)
	{}
	virtual ~ZTSTradeInfo(){}

public:
	static inline ZTSTradeInfo* create(const char* code, const char* exchg = "", ZTSBusinessType bType = BT_CASH)
	{
		ZTSTradeInfo *pRet = ZTSTradeInfo::allocate();
		vvt_strcpy(pRet->m_strExchg, exchg);
		vvt_strcpy(pRet->m_strCode, code);
		pRet->m_businessType = bType;
	...
	inline void setOffsetType(ZTSOffsetType oType)noexcept {m_offsetType = oType;}
	inline void setOrderType(ZTSOrderType ot)noexcept {m_orderType = ot;}
	inline void setTradeType(ZTSTradeType tt)noexcept {m_tradeType = tt;}
	...
	inline ZTSOffsetType	getOffsetType() const noexcept {return m_offsetType;}
	inline ZTSOrderType		getOrderType() const noexcept {return m_orderType;}
	inline ZTSTradeType		getTradeType() const noexcept {return m_tradeType;}
...
//////////////////////////////////////////////////////////////////////////
//持仓信息
class ZTSPositionItem : public ZTSPoolObject<ZTSPositionItem>
{
public:
	static inline ZTSPositionItem* create(const char* code, const char* currency = "CNY", const char* exchg = "", ZTSBusinessType bType = BT_CASH)
	{
		ZTSPositionItem *pRet = ZTSPositionItem::allocate();
		vvt_strcpy(pRet->m_strExchg, exchg);
		vvt_strcpy(pRet->m_strCode, code);
	...
	inline void setDirection(ZTSDirectionType dType){m_direction = dType;}
	...
	inline ZTSDirectionType getDirection() const{return m_direction;}
	...
	inline void setBusinessType(ZTSBusinessType bType) { m_businessType = bType; }
	inline ZTSBusinessType	getBusinessType() const { return m_businessType; }
...
protected:
	...
	ZTSDirectionType	m_direction;//多空方向
...
//////////////////////////////////////////////////////////////////////////
//账户信息
class ZTSAccountInfo : public ZTSPoolObject<ZTSAccountInfo>
{
public:
	ZTSAccountInfo()
		: m_strCurrency("CNY")
	...
	virtual ~ZTSAccountInfo(){}

public:
	static inline ZTSAccountInfo* create(){return ZTSAccountInfo::allocate();}
