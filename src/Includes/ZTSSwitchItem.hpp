...
NS_ZTP_BEGIN
class ZTSSwitchItem : public ZTSObject
{
protected:
	ZTSSwitchItem():_factor(1.0){}
	virtual ~ZTSSwitchItem(){}

public:
	static ZTSSwitchItem* create(const char* exchg, const char* product, const char* from, const char* to, uint32_t dt)
	{
		ZTSSwitchItem* pRet = new ZTSSwitchItem();
		pRet->_exchg = exchg;
