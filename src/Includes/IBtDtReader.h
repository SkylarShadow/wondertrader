...
public:
	virtual void init(ZTSVariant* cfg, IBtDtReaderSink* sink) { _sink = sink; }

	virtual bool read_raw_bars(const char* exchg, const char* code, ZTSKlinePeriod period, std::string& buffer) = 0;
