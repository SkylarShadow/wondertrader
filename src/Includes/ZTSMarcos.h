...
#define NS_ZTP_BEGIN	namespace vvtp{
#define NS_ZTP_END	}//namespace vvtp
#define	USING_NS_ZTP	using namespace vvtp
...
typedef unsigned int		ZTUInt32;
typedef unsigned long long	ZTUInt64;
