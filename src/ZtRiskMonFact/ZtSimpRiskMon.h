...
class ZtSimpleRiskMon : public ZtRiskMonitor
{
public:
	ZtSimpleRiskMon() :_stopped(false), _limited(false){}
...
public:
	...
	virtual void init(ZtPortContext* ctx, ZTSVariant* cfg) override;
