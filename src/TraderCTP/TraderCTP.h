...
private:
	...
	*/
	...
	ZTSEntrustAction*	makeAction(CThostFtdcInputOrderActionField *entrustField);
	ZTSError*		makeError(CThostFtdcRspInfoField* rspInfo, ZTSErrorCode ec = WEC_NONE);
	ZTSTradeInfo*	makeTradeInfo(CThostFtdcTradeField *tradeField);
