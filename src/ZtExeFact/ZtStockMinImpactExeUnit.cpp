...
ZtStockMinImpactExeUnit::ZtStockMinImpactExeUnit()
	: _last_tick(NULL)
	, _comm_info(NULL)
	, _price_mode(0)
	, _price_offset(0)
...
const char* ZtStockMinImpactExeUnit::getFactName()
{
	return FACT_NAME;
}

const char* ZtStockMinImpactExeUnit::getName()
{
	return "ZtStockMinImpactExeUnit";
}

void ZtStockMinImpactExeUnit::init(ExecuteContext* ctx, const char* stdCode, ZTSVariant* cfg)
{
...
void ZtStockMinImpactExeUnit::on_order(uint32_t localid, const char* stdCode, bool isBuy, double leftover, double price, bool isCanceled)
{
	{
...
void ZtStockMinImpactExeUnit::on_channel_ready()
{
...
void ZtStockMinImpactExeUnit::on_channel_lost()
{
}

void ZtStockMinImpactExeUnit::on_account(const char* currency, double prebalance, double balance, double dynbalance, double avaliable, double closeprofit, double dynprofit, double margin, double fee, double deposit, double withdraw)
{
...
void ZtStockMinImpactExeUnit::check_unmanager_order()
{
...
void ZtStockMinImpactExeUnit::on_tick(ZTSTickData* newTick)
{
...
void ZtStockMinImpactExeUnit::on_trade(uint32_t localid, const char* stdCode, bool isBuy, double vol, double price)
{
}

void ZtStockMinImpactExeUnit::on_entrust(uint32_t localid, const char* stdCode, bool bSuccess, const char* message)
{
	if (!bSuccess)
	{
		StdUniqueLock lock(_mtx_calc);
...
void ZtStockMinImpactExeUnit::set_position(const char* stdCode, double newVol)
{
	...
	ZTSTickData* tick = _ctx->grabLastTick(_code.c_str());
	if (tick)
	{
...
void ZtStockMinImpactExeUnit::clear_all_position(const char* stdCode)
{
	if (_code.compare(stdCode) != 0)
		return;
...
inline bool ZtStockMinImpactExeUnit::is_clear()
{
	return _is_clear;
}

void ZtStockMinImpactExeUnit::do_calc()
{
	if (!_last_tick)
		return;
	if (_is_finish)
