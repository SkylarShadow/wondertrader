...
public:
	bool	init_cta_factory(ZTSVariant* cfg);
...
public:
	//////////////////////////////////////////////////////////////////////////
	//IDataSink
	virtual void	handle_tick(const char* stdCode, ZTSTickData* curTick, uint32_t pxType = 0) override;
	...
	virtual void on_tick(const char* stdCode, ZTSTickData* newTick, bool bEmitStrategy = true) override;
	...
	virtual ZTSKlineSlice*	stra_get_bars(const char* stdCode, const char* period, uint32_t count, bool isMain = false) override;
...
protected:
	...
	typedef vvt_hashmap<std::string, ZTSTickStruct>	TickCache;
	TickCache	_ticks;
};