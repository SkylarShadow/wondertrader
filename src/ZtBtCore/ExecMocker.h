...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	//ExecuteContext
	virtual ZTSTickSlice* getTicks(const char* stdCode, uint32_t count, uint64_t etime = 0) override;

	virtual ZTSTickData* grabLastTick(const char* stdCode) override;
	...
	virtual ZTSCommodityInfo* getCommodityInfo(const char* stdCode) override;
	virtual ZTSSessionInfo* getSessionInfo(const char* stdCode) override;
