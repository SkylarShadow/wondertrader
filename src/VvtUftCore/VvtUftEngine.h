...
class VvtUftEngine : public IParserStub
{
public:
	VvtUftEngine();
	virtual ~VvtUftEngine();
...
public:
	void init(VvTSVariant* cfg, IBaseDataMgr* bdMgr, VvtUftDtMgr* dataMgr, EventNotifier* notifier);
