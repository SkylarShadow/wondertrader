...
VvtStraDtSel::VvtStraDtSel(const char* id)
	:SelStrategy(id)
{
}


VvtStraDtSel::~VvtStraDtSel()
{
}

const char* VvtStraDtSel::getName()
{
	return "DualThrustSelection";
}

const char* VvtStraDtSel::getFactName()
{
	return FACT_NAME;
}

bool VvtStraDtSel::init(VvTSVariant* cfg)
{
	if (cfg == NULL)
		return false;
...
void VvtStraDtSel::on_init(ISelStraCtx* ctx)
{
...
void VvtStraDtSel::on_schedule(ISelStraCtx* ctx, uint32_t uDate, uint32_t uTime)
{
...
void VvtStraDtSel::on_tick(ISelStraCtx* ctx, const char* stdCode, VvTSTickData* newTick)
{
}

void VvtStraDtSel::on_bar(ISelStraCtx* ctx, const char* stdCode, const char* period, VvTSBarStruct* newBar)
{
