...
const char* VvtSimpleRiskMon::getName()
{
	return "VvtSimpleRiskMon";
}

const char* VvtSimpleRiskMon::getFactName()
{
	return FACT_NAME;
}

void VvtSimpleRiskMon::init(VvtPortContext* ctx, VvTSVariant* cfg)
{
