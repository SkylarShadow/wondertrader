...
class VvtSimpleRiskMon : public VvtRiskMonitor
{
public:
	VvtSimpleRiskMon() :_stopped(false), _limited(false){}
...
public:
	...
	virtual void init(VvtPortContext* ctx, VvTSVariant* cfg) override;
