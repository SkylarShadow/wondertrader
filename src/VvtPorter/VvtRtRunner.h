...
#include "../VvtCore/VvtArbiExecuter.h"
...
class VvtRtRunner : public IEngineEvtListener, public ILogHandler, public IHisDataLoader
{
public:
	VvtRtRunner();
	~VvtRtRunner();
...
public:
	...
	VvtEngine*		getEngine(){ return _engine; }
