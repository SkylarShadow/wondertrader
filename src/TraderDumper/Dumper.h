...
public:
	...
	void on_order(const char* channelid, const char* exchg, const char* code, uint32_t curTDate,
		...
		uint32_t pricetype, ZTUInt64 ordertime, uint32_t state, const char* statemsg, bool isLast);
	...
	void on_trade(const char* channelid, const char* exchg, const char* code, uint32_t curTDate,
		...
		double amount, uint32_t ordertype, uint32_t tradetype, ZTUInt64 tradetime, bool isLast);
