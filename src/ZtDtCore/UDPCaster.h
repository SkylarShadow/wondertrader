...
private:
	...
	void	do_broadcast(ZTSObject* data, uint32_t dataType);

public:
	bool	init(ZTSVariant* cfg, ZTSBaseDataMgr* bdMgr, DataManager* dtMgr);
...
private:
	...
	typedef struct _CastData
	{
		...
		_CastData(ZTSObject* obj = NULL, uint32_t dataType = 0)
