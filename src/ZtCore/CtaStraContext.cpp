...
CtaStraContext::CtaStraContext(ZtCtaEngine* engine, const char* name, int32_t slippage)
...
//////////////////////////////////////////////////////////////////////////
//»Øµ÷º¯Êý
void CtaStraContext::on_bar_close(const char* code, const char* period, ZTSBarStruct* newBar)
{
	if (_strategy)
...
void CtaStraContext::on_tick_updated(const char* code, ZTSTickData* newTick)
{
