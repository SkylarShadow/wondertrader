...
//本地执行器
class ZtDiffExecuter : public ExecuteContext,
		public ITrdNotifySink, public IExecCommand
{
public:
	ZtDiffExecuter(ZtExecuterFactory* factory, const char* name, IDataManager* dataMgr, IBaseDataMgr* bdMgr);
	virtual ~ZtDiffExecuter();
...
public:
	//////////////////////////////////////////////////////////////////////////
	//ExecuteContext
	virtual ZTSTickSlice* getTicks(const char* code, uint32_t count, uint64_t etime = 0) override;

	virtual ZTSTickData*	grabLastTick(const char* code) override;
