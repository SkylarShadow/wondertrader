/*!
 * \file VvtStockMinImpactExeUnit.h
 *
 * \author Wesley
 * \date 2020/03/30
 *
...
class VvtStockMinImpactExeUnit : public ExecuteUnit
{
private:
...
public:
	VvtStockMinImpactExeUnit();
	virtual ~VvtStockMinImpactExeUnit();
...
public:
	...
	inline double get_minOrderQty(std::string stdCode)
	{
		...
		VvTSCommodityInfo* comm_info = _ctx->getCommodityInfo(stdCode.c_str());
