...
VvtStockMinImpactExeUnit::VvtStockMinImpactExeUnit()
	: _last_tick(NULL)
	, _comm_info(NULL)
	, _price_mode(0)
	, _price_offset(0)
...
const char* VvtStockMinImpactExeUnit::getFactName()
{
	return FACT_NAME;
}

const char* VvtStockMinImpactExeUnit::getName()
{
	return "VvtStockMinImpactExeUnit";
}

void VvtStockMinImpactExeUnit::init(ExecuteContext* ctx, const char* stdCode, VvTSVariant* cfg)
{
...
void VvtStockMinImpactExeUnit::on_order(uint32_t localid, const char* stdCode, bool isBuy, double leftover, double price, bool isCanceled)
{
	{
...
void VvtStockMinImpactExeUnit::on_channel_ready()
{
...
void VvtStockMinImpactExeUnit::on_channel_lost()
{
}

void VvtStockMinImpactExeUnit::on_account(const char* currency, double prebalance, double balance, double dynbalance, double avaliable, double closeprofit, double dynprofit, double margin, double fee, double deposit, double withdraw)
{
...
void VvtStockMinImpactExeUnit::check_unmanager_order()
{
...
void VvtStockMinImpactExeUnit::on_tick(VvTSTickData* newTick)
{
...
void VvtStockMinImpactExeUnit::on_trade(uint32_t localid, const char* stdCode, bool isBuy, double vol, double price)
{
}

void VvtStockMinImpactExeUnit::on_entrust(uint32_t localid, const char* stdCode, bool bSuccess, const char* message)
{
	if (!bSuccess)
	{
		StdUniqueLock lock(_mtx_calc);
...
void VvtStockMinImpactExeUnit::set_position(const char* stdCode, double newVol)
{
...
void VvtStockMinImpactExeUnit::clear_all_position(const char* stdCode)
{
	if (_code.compare(stdCode) != 0)
		return;
...
inline bool VvtStockMinImpactExeUnit::is_clear()
{
	return _is_clear;
}

void VvtStockMinImpactExeUnit::do_calc()
{
	if (!_last_tick)
		return;
	if (_is_finish)
