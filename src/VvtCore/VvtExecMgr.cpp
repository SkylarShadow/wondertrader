...
//////////////////////////////////////////////////////////////////////////
#pragma region "VvtExecuterMgr"
void VvtExecuterMgr::enum_executer(EnumExecuterCb cb)
{
...
void VvtExecuterMgr::set_positions(vvt_hashmap<std::string, double> target_pos)
{
	if(_filter_mgr != NULL)
	{
...
void VvtExecuterMgr::handle_pos_change(const char* stdCode, double targetPos, double diffPos, const char* execid /* = "ALL" */)
{
	if(_filter_mgr != NULL)
	{
...
void VvtExecuterMgr::handle_tick(const char* stdCode, VvTSTickData* curTick)
{
...
void VvtExecuterMgr::add_target_to_cache(const char* stdCode, double targetPos, const char* execid /* = "ALL" */)
{
...
void VvtExecuterMgr::commit_cached_targets(double scale /* = 1.0 */)
{
...
bool VvtExecuterMgr::load_router_rules(VvTSVariant* config)
{
...
#pragma endregion "VvtExecuterMgr"
