...
class VvtSelRtTicker;


class VvtSelEngine : public VvtEngine, public IExecuterStub
{
public:
	VvtSelEngine();
	~VvtSelEngine();
...
public:
	//////////////////////////////////////////////////////////////////////////
	//VvtEngine接口
	virtual void init(VvTSVariant* cfg, IBaseDataMgr* bdMgr, VvtDtMgr* dataMgr, IHotMgr* hotMgr, EventNotifier* notifier) override;
...
private:
	...
	VvtExecuterMgr	_exec_mgr;

	bool	_terminated;

	VvtSelRtTicker*	_tm_ticker;
	VvTSVariant*		_cfg;
};
