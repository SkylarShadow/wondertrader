...
//本地执行器
class VvtDiffExecuter : public ExecuteContext,
		public ITrdNotifySink, public IExecCommand
{
public:
	VvtDiffExecuter(VvtExecuterFactory* factory, const char* name, IDataManager* dataMgr, IBaseDataMgr* bdMgr);
	virtual ~VvtDiffExecuter();
