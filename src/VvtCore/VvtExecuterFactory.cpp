...
//////////////////////////////////////////////////////////////////////////
//VvtExecuterFactory
bool VvtExecuterFactory::loadFactories(const char* path)
{
...
ExecuteUnitPtr VvtExecuterFactory::createExeUnit(const char* factname, const char* unitname)
{
...
ExecuteUnitPtr VvtExecuterFactory::createDiffExeUnit(const char* factname, const char* unitname)
{
	auto it = _factories.find(factname);
	if (it == _factories.end())
		return ExecuteUnitPtr();
...
ExecuteUnitPtr VvtExecuterFactory::createArbiExeUnit(const char* factname, const char* unitname)
{
	auto it = _factories.find(factname);
	if (it == _factories.end())
		return ExecuteUnitPtr();
...
ExecuteUnitPtr VvtExecuterFactory::createExeUnit(const char* name)
{
...
ExecuteUnitPtr VvtExecuterFactory::createDiffExeUnit(const char* name)
{
	StringVector ay = StrUtil::split(name, ".");
	if (ay.size() < 2)
		return ExecuteUnitPtr();
...
ExecuteUnitPtr VvtExecuterFactory::createArbiExeUnit(const char* name)
{
	StringVector ay = StrUtil::split(name, ".");
	if (ay.size() < 2)
		return ExecuteUnitPtr();
