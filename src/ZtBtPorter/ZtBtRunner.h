...
#include "../ZtBtCore/EventNotifier.h"
#include "../ZtBtCore/HisDataReplayer.h"
...
class ZtBtRunner : public IBtDataLoader
{
public:
	ZtBtRunner();
	~ZtBtRunner();
	...
	void feedRawTicks(ZTSTickStruct* ticks, uint32_t count);
...
public:
	...
	bool	initEvtNotifier(ZTSVariant* cfg);
	...
	void	ctx_on_tick(uint32_t id, const char* stdCode, ZTSTickData* newTick, EngineType eType);
	...
	void	ctx_on_bar(uint32_t id, const char* stdCode, const char* period, ZTSBarStruct* newBar, EngineType eType);
