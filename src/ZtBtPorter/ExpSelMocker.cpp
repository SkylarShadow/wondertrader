...
void ExpSelMocker::on_tick_updated(const char* stdCode, ZTSTickData* newTick)
{
...
void ExpSelMocker::on_bar_close(const char* stdCode, const char* period, ZTSBarStruct* newBar)
{
