...
void ExpCtaMocker::on_tick_updated(const char* stdCode, ZTSTickData* newTick)
{
...
void ExpCtaMocker::on_bar_close(const char* code, const char* period, ZTSBarStruct* newBar)
{
