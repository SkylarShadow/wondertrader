...
extern "C"
{
	...
	EXPORT_FLAG void		feed_raw_bars(ZTSBarStruct* bars, ZTUInt32 count);

	EXPORT_FLAG void		feed_raw_ticks(ZTSTickStruct* ticks, ZTUInt32 count);

	EXPORT_FLAG void		feed_adj_factors(ZTString stdCode, ZTUInt32* dates, double* factors, ZTUInt32 count);
	...
	EXPORT_FLAG	void		set_time_range(ZTUInt64 stime, ZTUInt64 etime);
	...
	EXPORT_FLAG	CtxHandler	init_sel_mocker(const char* name, ZTUInt32 date, ZTUInt32 time, const char* period, const char* trdtpl = "CHINA", const char* session = "TRADING", int slippage = 0, bool bRatioSlp = false);

	EXPORT_FLAG	void		run_backtest(bool bNeedDump, bool bAsync);

	EXPORT_FLAG	void		write_log(ZTUInt32 level, const char* message, const char* catName);
	...
	EXPORT_FLAG	ZTString	get_raw_stdcode(const char* stdCode);
...
#pragma region "CTA接口"
	...
	EXPORT_FLAG	ZTUInt64	cta_get_detail_entertime(CtxHandler cHandle, const char* stdCode, const char* openTag);
	...
	EXPORT_FLAG	ZTUInt32 	cta_get_tdate();

	EXPORT_FLAG	ZTUInt32 	cta_get_date();

	EXPORT_FLAG	ZTUInt32 	cta_get_time();

	EXPORT_FLAG	ZTUInt32	cta_get_bars(CtxHandler cHandle, const char* stdCode, const char* period, ZTUInt32 barCnt, bool isMain, FuncGetBarsCallback cb);

	EXPORT_FLAG	ZTUInt32	cta_get_ticks(CtxHandler cHandle, const char* stdCode, ZTUInt32 tickCnt, FuncGetTicksCallback cb);

	EXPORT_FLAG void		cta_get_all_position(CtxHandler cHandle, FuncGetPositionCallback cb);

	EXPORT_FLAG	ZTUInt64	cta_get_first_entertime(CtxHandler cHandle, const char* stdCode);

	EXPORT_FLAG	ZTUInt64	cta_get_last_entertime(CtxHandler cHandle, const char* stdCode);

	EXPORT_FLAG	ZTUInt64	cta_get_last_exittime(CtxHandler cHandle, const char* stdCode);

	EXPORT_FLAG	double		cta_get_last_enterprice(CtxHandler cHandle, const char* stdCode);

	EXPORT_FLAG	ZTString	cta_get_last_entertag(CtxHandler cHandle, const char* stdCode);

	EXPORT_FLAG	void		cta_log_text(CtxHandler cHandle, ZTUInt32 level, const char* message);

	EXPORT_FLAG	void		cta_save_userdata(CtxHandler cHandle, const char* key, const char* val);

	EXPORT_FLAG	ZTString	cta_load_userdata(CtxHandler cHandle, const char* key, const char* defVal);
	 ...
	 */
	EXPORT_FLAG void		cta_register_index(CtxHandler cHandle, const char* idxName, ZTUInt32 indexType);
	 ...
	 *	@lineType	线性，0-曲线
	 */
	EXPORT_FLAG bool		cta_register_index_line(CtxHandler cHandle, const char* idxName, const char* lineName, ZTUInt32 lineType);
...
#pragma  region "SEL接口"
	...
	EXPORT_FLAG	ZTUInt32 	sel_get_date();

	EXPORT_FLAG	ZTUInt32 	sel_get_time();

	EXPORT_FLAG	ZTUInt32	sel_get_bars(CtxHandler cHandle, const char* stdCode, const char* period, ZTUInt32 barCnt,FuncGetBarsCallback cb);

	EXPORT_FLAG	ZTUInt32	sel_get_ticks(CtxHandler cHandle, const char* stdCode, ZTUInt32 tickCnt,FuncGetTicksCallback cb);

	EXPORT_FLAG void		sel_get_all_position(CtxHandler cHandle, FuncGetPositionCallback cb);

	EXPORT_FLAG	void		sel_log_text(CtxHandler cHandle, ZTUInt32 level, const char* message);

	EXPORT_FLAG	void		sel_save_userdata(CtxHandler cHandle, const char* key, const char* val);

	EXPORT_FLAG	ZTString	sel_load_userdata(CtxHandler cHandle, const char* key, const char* defVal);
	...
	EXPORT_FLAG	ZTUInt64	sel_get_detail_entertime(CtxHandler cHandle, const char* stdCode, const char* openTag);
	...
	EXPORT_FLAG	ZTUInt32 	sel_get_tdate();

	EXPORT_FLAG	ZTUInt64	sel_get_first_entertime(CtxHandler cHandle, const char* stdCode);

	EXPORT_FLAG	ZTUInt64	sel_get_last_entertime(CtxHandler cHandle, const char* stdCode);

	EXPORT_FLAG	ZTUInt64	sel_get_last_exittime(CtxHandler cHandle, const char* stdCode);

	EXPORT_FLAG	double		sel_get_last_enterprice(CtxHandler cHandle, const char* stdCode);

	EXPORT_FLAG	ZTString	sel_get_last_entertag(CtxHandler cHandle, const char* stdCode);
...
#pragma  region "HFT接口"
	...
	EXPORT_FLAG	ZTUInt32 	hft_get_date();

	EXPORT_FLAG	ZTUInt32 	hft_get_time();

	EXPORT_FLAG	ZTUInt32 	hft_get_secs();

	EXPORT_FLAG	ZTUInt32	hft_get_bars(CtxHandler cHandle, const char* stdCode, const char* period, ZTUInt32 barCnt, FuncGetBarsCallback cb);

	EXPORT_FLAG	ZTUInt32	hft_get_ticks(CtxHandler cHandle, const char* stdCode, ZTUInt32 tickCnt, FuncGetTicksCallback cb);

	EXPORT_FLAG	ZTUInt32	hft_get_ordque(CtxHandler cHandle, const char* stdCode, ZTUInt32 tickCnt, FuncGetOrdQueCallback cb);

	EXPORT_FLAG	ZTUInt32	hft_get_orddtl(CtxHandler cHandle, const char* stdCode, ZTUInt32 tickCnt, FuncGetOrdDtlCallback cb);

	EXPORT_FLAG	ZTUInt32	hft_get_trans(CtxHandler cHandle, const char* stdCode, ZTUInt32 tickCnt, FuncGetTransCallback cb);

	EXPORT_FLAG	void		hft_log_text(CtxHandler cHandle, ZTUInt32 level, const char* message);
	...
	EXPORT_FLAG	bool		hft_cancel(CtxHandler cHandle, ZTUInt32 localid);

	EXPORT_FLAG	ZTString	hft_cancel_all(CtxHandler cHandle, const char* stdCode, bool isBuy);

	EXPORT_FLAG	ZTString	hft_buy(CtxHandler cHandle, const char* stdCode, double price, double qty, const char* userTag, int flag);

	EXPORT_FLAG	ZTString	hft_sell(CtxHandler cHandle, const char* stdCode, double price, double qty, const char* userTag, int flag);

	EXPORT_FLAG	void		hft_save_userdata(CtxHandler cHandle, const char* key, const char* val);

	EXPORT_FLAG	ZTString	hft_load_userdata(CtxHandler cHandle, const char* key, const char* defVal);
